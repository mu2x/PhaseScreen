...
RytovV=[1] % [.1 1:.5:3]; %[.1:.1:1 1.5 2 2.5 3]; % Rytov=0.312 * k^(7/6) * Dz_s^(11/6) * Cn2;
kpowV=22/6; %[19:23 23.8]/6; %[19:23 23.2:.2:23.8]/6; %[20:24]/6 % Cn2 calculated using 22/6
