...
for Rytov=RytovV; 
%Dr.Rao[varI/Rytov=
%  [.40/.1,  .77/.2,    1.1/.3,   1.3/.4,   1.7/.6,   1.9/.8,   1.98/1]
%   4.0000    3.8500    3.6667    3.2500    2.8333    2.3750    1.9800
tic
...
for itrial=1:ntrial % Note: ntrial still need fixing
  ...
  for idx=1:nscreen-1
    %phz=ft_phase_screenBeta(Cn2,N,deltax,Lout,Lin,factor,(11+mu)/3,'Kol');
